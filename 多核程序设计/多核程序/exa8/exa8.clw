...
NewFileInclude2=#include "exa8.h"
LastPage=0
...
Type=0
HeaderFile=exa8.h
ImplementationFile=exa8.cpp
Filter=N

[CLS:CExa8Doc]
Type=0
HeaderFile=exa8Doc.h
ImplementationFile=exa8Doc.cpp
Filter=N

[CLS:CExa8View]
Type=0
HeaderFile=exa8View.h
ImplementationFile=exa8View.cpp
Filter=C
